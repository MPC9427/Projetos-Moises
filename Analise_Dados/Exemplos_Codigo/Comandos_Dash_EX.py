#A ideia é criar:
#- ✅ KPIs (quantidade de marcas, fabricantes, modelos, computadores)
#- ✅ Filtros (dropdown para Marca e Fabricante)
#- ✅ Gráficos (barras e pizza)
#- ✅ Leitura do Excel
#Tudo isso em um layout limpo usando Dash + Plotly.

#📊 Dashboard simples com suas colunas (código completo)
import dash
...
#✅ O que esse dashboard entrega
#- Filtros por Marca e Fabricante
#- KPIs automáticos
#- Gráfico de barras por marca
#- Gráfico de pizza por fabricante
#- Atualização automática ao mudar filtros
#- Conexão direta com seu Excel
